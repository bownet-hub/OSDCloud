function Send-Email {
    param(
        ...
        [Parameter(Mandatory = $False)] [string] $ToRecipient,
...
Send-Email -ClientId $ClientId -ClientSecret $ClientSecret -TenantID $TenantId -ToRecipient $ToRecipient -From $from -attachmentPath $attachmentPath